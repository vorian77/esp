...
type $MoedPartData = $.ObjectType<"org_client_baltimore::MoedPartData", $MoedPartDataλShape, null, [
  ..._sys_core.$SysObj['__exclusives__'],
], "org_client_baltimore::MoedPartData">;
...
export type $MoedParticipantλShape = $.typeutil.flatten<_app_cm.$CmClientλShape & {
  ...
  "<participant[is org_client_baltimore::MoedPartData]": $.LinkDesc<$MoedPartData, $.Cardinality.Many, {}, false, false,  false, false>;
  "<participant": $.LinkDesc<$.ObjectType, $.Cardinality.Many, {}, false, false,  false, false>;
}>;
type $MoedParticipant = $.ObjectType<"org_client_baltimore::MoedParticipant", $MoedParticipantλShape, null, [
  ..._app_cm.$CmClient['__exclusives__'],
], "org_client_baltimore::MoedParticipant">;
