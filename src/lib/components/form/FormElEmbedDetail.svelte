<script lang="ts">
	...
	import { DataObj, DataObjCardinality, type DataObjData, ResponseBody } from '$utils/types'
	...
	function setStateEmbed(ids: string[]) {
		stateEmbed = new StateSurfaceEmbed({
			...
			dataObjSource: new TokenApiDbDataObjSource({ dataObjId: field.raw.dataObjId }),
