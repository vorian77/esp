...
function initUserType(init: InitDb) {
	...
	init.addTrans('sysUserType', {
		...
		owner: 'sys_ai',
		resources: [
			{ owner: 'sys_ai', name: 'app_client_ai_staff' },
			{ owner: 'sys_system', name: 'app_sys_reporting' },
			{ owner: 'sys_ai', name: 'report_ai_cohort_performance' },
			{ owner: 'sys_ai', name: 'report_ai_course_performance' },
			// { owner: 'sys_ai', name: 'report_ai_cohorts_detail' },
			// { owner: 'sys_ai', name: 'report_ai_courses_detail' },
			// {  owner: 'sys_ai', name: 'report_ai_partners_detail' },
			// {  owner: 'sys_ai', name: 'report_ai_student_attd_detail' },
			// {  owner: 'sys_ai', name: 'report_ai_student_docs_detail' },
			// {  owner: 'sys_ai', name: 'report_ai_student_notes_detail' },
			{ owner: 'sys_ai', name: 'report_ai_student_cohort_attd_summary' },
			{ owner: 'sys_ai', name: 'report_ai_student_job_placement_detail' },
			{
				owner: 'sys_ai',
				name: 'report_ai_student_school_placement_detail'
			},
			{ owner: 'sys_ai', name: 'report_ai_student_roster' }
			// { owner: 'sys_ai', name: 'report_ai_student_service_flow_summary' },
		]
	})

	/* MOED */
	init.addTrans('sysUserType', {
		attributes: [{ hasAccess: true, name: 'moedOfficeEastside', owner: 'sys_moed' }],
	...
	init.addTrans('sysUserType', {
		...
		owner: 'sys_moed',
		resources: [
			{ owner: 'sys_moed', name: 'app_client_moed_advocate' },
			// { owner: 'sys_system', name: 'app_sys_reporting' },
			// { owner: 'sys_moed', name: 'report_moed_self_serv_student_status' },
			{ owner: 'sys_moed', name: 'task_moed_part_apps_open' },
			{ owner: 'sys_moed', name: 'task_moed_part_msgs_open' }
		],
		tags: [{ codeType: 'ct_sys_user_type_tag_role', code: 'utt_role_moed_staff' }]
	})
	init.addTrans('sysUserType', {
		attributes: [{ hasAccess: true, name: 'moedOfficeWestside', owner: 'sys_moed' }],
	...
	init.addTrans('sysUserType', {
		...
		owner: 'sys_moed',
		resources: [
			{ owner: 'sys_moed', name: 'task_moed_ssr_app' },
			{ owner: 'sys_moed', name: 'task_moed_ssr_app_doc' },
			{ owner: 'sys_moed', name: 'task_moed_ssr_app_msg' },
			{ owner: 'sys_moed', name: 'task_moed_ssr_welcome' }
		]
	})
}
...
function initUsers(init: InitDb) {
	...
	init.addTrans('sysUser', {
		...
		owner: 'org_system',
		systems: ['sys_ai', 'sys_app_crm', 'sys_client_app_factory', 'sys_moed', 'sys_system'],
		userName: 'user_sys',
		userTypes: [
			'ut_app_crm_admin',
			'ut_sys_admin_global',
	...
	init.addTrans('sysUser', {
		...
		systems: ['sys_ai', 'sys_app_crm', 'sys_client_app_factory'],
		userName: '2487985578',
