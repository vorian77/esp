		...
		elements: [
			...
			...[
				...
				},
				{
					...
					exprCustom: `<fSysRate,.computedHours,.hours>`,
...
cohortWages := (SELECT completed {cohort, wages := (SELECT app_cm::CmCsfJobPlacement FILTER .csf = completed.csf).wage})`,
		...
		elements: [
			...
			},
			{
				...
				codeFieldElement: 'number',
				codeReportElementType: 'column',
				exprCustom: `<fSysRate,.completedCnt,.enrolledCnt>`,
			...
			},
			{
				...
				codeFieldElement: 'number',
				codeReportElementType: 'column',
				exprCustom: `<fSysRate,.completedPlacedCnt,.completedCnt>`,
			...
			},
			{
				...
				codeFieldElement: 'number',
				codeReportElementType: 'column',
				exprCustom: `<fSysRate,.completedPlacedRelatedCnt,.completedCnt>`,
		...
		elements: [
			...
			...[
				...
				},
				{
					...
					codeReportElementType: 'column',
					description: 'Student Attendance Days" devided by "Cohort Attendance Days.',
					exprCustom: `<fSysRate,.attdDaysStudent,.attdDaysCohort>`,
					header: 'Attendance Rate (%)',
					isDisplay: true,
					isDisplayable: true,
					nameCustom: 'attdRate',
