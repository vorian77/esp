		...
		elements: [
			...
			...[
				...
				},
				{
					...
					exprCustom: `<rate,.computedHours,.hours>`,
...
cohortWages := (SELECT completed {cohort, wages := (SELECT app_cm::CmCsfJobPlacement FILTER .csf = completed.csf).wage})`,
		...
		elements: [
			...
			},
			{
				...
				codeFieldElement: 'number',
				codeReportElementType: 'column',
				exprCustom: `<rate,.completedCnt,.enrolledCnt>`,
			...
			},
			{
				...
				codeFieldElement: 'number',
				codeReportElementType: 'column',
				exprCustom: `<rate,.completedPlacedCnt,.completedCnt>`,
			...
			},
			{
				...
				codeFieldElement: 'number',
				codeReportElementType: 'column',
				exprCustom: `<rate,.completedPlacedRelatedCnt,.completedCnt>`,
		...
		elements: [
			...
			...[
				...
				},
				{
					...
					codeReportElementType: 'column',
					description: 'Student Attendance Days" devided by "Cohort Attendance Days.',
					exprCustom: `<rate,.attdDaysStudent,.attdDaysCohort>`,
					header: 'Attendance Rate (%)',
					isDisplay: true,
					isDisplayable: true,
					nameCustom: 'attdRate',
