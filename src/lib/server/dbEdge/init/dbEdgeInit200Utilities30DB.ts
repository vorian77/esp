	...
	const query = e.params(
		{
			...
			toggleContinueRequiresTrue: e.optional(e.bool),
		...
		(p) => {
			return e.insert(e.sys_db.SysColumn, {
				...
				isFormTag: valueOrDefaultParm(p.isFormTag, false),
				...
				spinStep: p.spinStep,
				toggleContinueRequiresTrue: p.toggleContinueRequiresTrue,
