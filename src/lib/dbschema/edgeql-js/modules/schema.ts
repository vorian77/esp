...
export type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is SysPersonTest]": $.LinkDesc<_default.$SysPersonTest, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is sys_core::SysResource]": $.LinkDesc<_sys_core.$SysResource, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is sys_rep::SysRepUserEl]": $.LinkDesc<_sys_rep.$SysRepUserEl, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is sys_user::SysUserTypeTag]": $.LinkDesc<_sys_user.$SysUserTypeTag, $.Cardinality.Many, {}, false, false,  false, false>;
