...
export type $SysOrgλShape = $.typeutil.flatten<Omit<$ObjRootλShape, "<owner"> & _sys_user.$MgmtλShape & {
...
export type $SysSystemλShape = $.typeutil.flatten<Omit<$ObjRootλShape, "<owner"> & _sys_user.$MgmtλShape & {
